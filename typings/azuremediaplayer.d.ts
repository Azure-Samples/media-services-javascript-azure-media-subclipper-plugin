...
declare module amp {
    interface VideoEditor {
        setMarkIn(value: number): void;
        setMarkOut(value: number): void;
    }
    /**
    ...
    */
    export interface XMLHttpRequestWrapper {
        ...
        send(data?: any): void; // AS Custom Fix return type void;
    }
...
declare module amp.Player {
    ...
    interface Options {
        ...
        // AS: Custom Fix
        /**
         * Set height of the component (CSS values).
         * Setting the video tag dimension values works with values in pixels, % or 'auto'.
         */
        height?: string;
        ...
        // AS: Custom Fix
        /**
         * Set width of the component (CSS values).
         * Setting the video tag dimension values works with values in pixels, % or 'auto'.
         */
        width?: string;
    }
...
interface Window {
    amp: (id: any, options?: amp.Player.Options, ready?: Function) => amp.Player;
}
